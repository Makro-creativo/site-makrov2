    ...
    data() {
        return {
            ...
            projects: [
                ...
                { title: 'Tienda Mercado Libre Guzvar', image: 'https://cdn.jsdelivr.net/gh/PaulMaldonado/img-web/portfolio-images/tienda_guzvar_portafolio_pagina_web.svg', category: 'PÁGINAS WEB', url: 'https://www.tienda.guzvar.com/' },
            ],
        }
    },
